...
def sales_statistics(sales: list[dict]) -> dict:
    """Функция возвращает словарь, содержащий информацию о средней стоимости заказа
    ...
    for item in sales:  # формируем список со словарем вида дата:сумма товаров в заказе
